        ...
        <div className="flex h-16 justify-between">
          <div className="flex px-2 lg:px-0">
            ...
            <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
              ...
              <a
                href="A-propos"
                onClick={() => setSelected("A-propos")}
                className={
                  selected === "A-propos" ? styleSelected : styleDefault
                }
              >
                À propos
              </a>
              <a
                href="Nos-produits"
                onClick={() => setSelected("Nos-produits")}
                className={
                  selected === "Nos-produits" ? styleSelected : styleDefault
                }
              >
                Nos Produits
              </a>
              <a
                ...
                className={
                  selected === "Contact" ? styleSelected : styleDefault
                }
              >
                Contact
              </a>
